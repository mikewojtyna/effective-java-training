package pro.buildmysoftware.patterns.strategy;
...
public class LineItem {
	...
	public String toString() {
		return "LineItem{" + "productName='" + productName + '\'' + "," +
	...
	public boolean equals(Object o) {
		...
		return count == lineItem.count && Objects
			.equals(productName, lineItem.productName) && Objects
			.equals(productPrice, lineItem.productPrice);
	}
